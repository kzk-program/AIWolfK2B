...
class HumanPlayer(object):
    ...
    def initialize(self, game_info, game_setting):
        ...
        print("Your Agent Id is " + str(self.agentIdx))
        print("Your Role is " + self.myRole)
        self.pandas_rowid = len(self.gameDataFrame)
    ...
    def update(self, game_info, talk_history, whisper_history, request):
        ...
        pd.set_option('display.max_rows', len(self.gameDataFrame))
        print(self.gameDataFrame[self.pandas_rowid:])
    ...
    def whisper(self):
        return input('whisper:')
        
    def vote(self):
        return int(input('vote:'))
    
    def attack(self):
        return int(input('attack:'))
    
    def divine(self):
        return int(input('divine:'))
    
    def guard(self):
        return int(input('guard:'))
...
agent = HumanPlayer('human_pandas_player')
